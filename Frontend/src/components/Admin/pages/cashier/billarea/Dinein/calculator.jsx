...
export default function Calculator({ setCalculator, tableData, totalAfterDiscount }) {
  ...
  return (
    <div className='space-y-4'>
        <div className='flex justify-between items-center'>
            ...
            <h1 className='text-xl font-bold'>Table No: {tableData?.table?.name || "N/A"}</h1>
        </div>
        ...
        <div className='space-y-2'>
            <label htmlFor="" className='flex justify-center items-center'>Return Amount</label>
            <input 
        ...
        <button className='w-full bg-gray-900 p-2 rounded' onClick={() => setCalculator(false)}>Close</button>
    </div>
  );
}
