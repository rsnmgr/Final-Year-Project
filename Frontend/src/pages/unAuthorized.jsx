...
export default function UnAuthorized() {
  ...
  return (
    <main className="flex flex-col md:flex-col xl:flex-row w-full h-full px-4 py-20 sm:px-6 md:px-8 lg:px-10 bg-gray-950">
      <RedirectHandler /> {/* This ensures the user is redirected if they refresh the page */}
      <div className="flex flex-col justify-center items-center px-4 py-20 md:px-8 lg:px-2 text-gray-700 w-full">
        ...
        <p className="text-base sm:text-lg md:text-xl mt-8 mb-10 text-center text-white w-full max-w-[900px]">
          Sorry, looks like you have attempted to access a page for which you are not authorized! Try logging in as a different user or go back to the home page.
        </p>
        <button 
          onClick={() => navigate('/')} 
